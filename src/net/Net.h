...
public:
    ...
    void SetDriver(std::unique_ptr<NetDriver>&& driver) { Driver = std::move(driver); }
    std::unique_ptr<NetDriver>& GetDriver() { return Driver; }
    const std::unique_ptr<NetDriver>& GetDriver() const { return Driver; }
